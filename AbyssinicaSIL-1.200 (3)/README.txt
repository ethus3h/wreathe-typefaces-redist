...
(http://scripts.sil.org/AbyssinicaSIL_Support) for frequently
...
If you do find a problem, please do report it to <sil_fonts AT sil DOT org>.
...
the Keyman program (www.tavultesoft.com) prior to installing the Keyman
